...
- (void)testDefensiveImageAccessorWithURLString {
    ...
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":imageUrl} andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}

- (void)testDefensiveImageAccessorWithImageObjectAndContentUrl {
    NSString *imageUrl = @"http://example.com/image.png";
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@{@"contentUrl":imageUrl}} andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}

- (void)testDefensiveImageAccessorWithImageObjectAndEmbedUrl {
    NSString *imageUrl = @"http://example.com/image.png";
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@{@"embedUrl":imageUrl}} andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}

- (void)testDefensiveImageAccessorWithImageObjectAndUrl {
    NSString *imageUrl = @"http://example.com/image.png";
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@{@"url":imageUrl}} andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}
...
- (void)testDefensiveImagesAccessorWithMultipleImages {
    ...
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@[@{@"url":image1},image2,@{@"contentUrl":image3},@{@"embedUrl":image4}]} andCorrelationId:nil];
