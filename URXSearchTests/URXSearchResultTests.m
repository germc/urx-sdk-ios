//
//  URXSearchResultTests.m
//  URXSearch
//
//  Created by James Turner on 9/30/14.
...
- (void)testDefensiveImageAccessorWithURLString {
    ...
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":imageUrl} resultPosition:[NSNumber numberWithInt:0] andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}

- (void)testDefensiveImageAccessorWithImageObjectAndContentUrl {
    NSString *imageUrl = @"http://example.com/image.png";
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@{@"contentUrl":imageUrl}} resultPosition:[NSNumber numberWithInt:0] andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}

- (void)testDefensiveImageAccessorWithImageObjectAndEmbedUrl {
    NSString *imageUrl = @"http://example.com/image.png";
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@{@"embedUrl":imageUrl}} resultPosition:[NSNumber numberWithInt:0] andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}

- (void)testDefensiveImageAccessorWithImageObjectAndUrl {
    NSString *imageUrl = @"http://example.com/image.png";
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@{@"url":imageUrl}} resultPosition:[NSNumber numberWithInt:0] andCorrelationId:nil];
    XCTAssert([[r imageUrl] isEqualToString:imageUrl]);
}
...
- (void)testDefensiveImagesAccessorWithMultipleImages {
    ...
    URXSearchResult *r = [URXSearchResult searchResultFromEntityData:@{@"image":@[@{@"url":image1},image2,@{@"contentUrl":image3},@{@"embedUrl":image4}]} resultPosition:[NSNumber numberWithInt:0] andCorrelationId:nil];
